...
const MainDish = () => {
  return (
    <>
      <section className="section featured maindish">
          ...
          <OwlCarousel {...options}>
            ...
            <div className="staf-card">
              <div className="staf-img-container">
                <img src="/img/s2.jpeg" alt="person" className="staf-img" />
              </div>
              <div className="staf-footer">
                <h4 className="staf-title">item_3</h4>
                <div className="staf-info">
                  <p className="staf-country">price : $30</p>
                </div>
              </div>
            </div>
            {/* one card */}
